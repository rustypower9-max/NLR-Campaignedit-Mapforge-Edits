...
economy = {
	...
	CAPITALIST_BUILD_FACTORY_STATE_EMPLOYMENT_PERCENT = 0.2, -- Capis don't build factories if less than this percent is employed in existing factories
...
ai =
{
	...
	RELATION_LIMIT_NO_ALLIANCE_OFFER = 30, -- if relation lower then this value, AI will not ally
